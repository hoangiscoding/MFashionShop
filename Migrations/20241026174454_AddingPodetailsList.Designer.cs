...
namespace FashionShop.Migrations
{
    ...
    [Migration("20241026174454_AddingPodetailsList")]
    partial class AddingPodetailsList
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FashionShop.Models.PoHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FashionShop.Models.Currency", b =>
                {
                    b.HasOne("FashionShop.Models.Currency", "Currencies")
                        .WithMany()
            ...
            modelBuilder.Entity("FashionShop.Models.PoDetail", b =>
                {
                    b.HasOne("FashionShop.Models.PoHeader", "PoHeader")
                        .WithMany("PoDetails")
                        .HasForeignKey("PoId")
            ...
            modelBuilder.Entity("FashionShop.Models.Product", b =>
                {
                    b.HasOne("FashionShop.Models.Brand", "Brands")
                        .WithMany()
                        .HasForeignKey("BrandId");

                    b.HasOne("FashionShop.Models.Category", "Categories")
                        .WithMany()
                        .HasForeignKey("CategoryId");

                    b.HasOne("FashionShop.Models.ProductGroup", "ProductGroups")
                        .WithMany()
                        .HasForeignKey("ProductGroupId");

                    b.HasOne("FashionShop.Models.ProductProfile", "ProductProfiles")
                        .WithMany()
                        .HasForeignKey("ProductProfileId");

                    b.HasOne("FashionShop.Models.Unit", "Units")
                        .WithMany()
